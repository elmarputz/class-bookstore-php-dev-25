...
<ul class="nav nav-tabs">
    <?php foreach ($categories as $cat) : ?>
        <li role="presentation" class="navitem">
            <button class="nav-link <?php if ($cat->getId() === $categoryId) : ?>active <?php endif; ?>"><a href="<?php echo $_SERVER['PHP_SELF'] ?>?view=list&amp;categoryId=<?php echo urlencode($cat->getId()); ?>"><?php echo Util::escape($cat->getName()); ?></a></button>
        </li>
    <?php endforeach; ?>
</ul>
